...
<LINE, ADJACENT_TYAPP> "F#*)"           { return makeToken(BLOCK_COMMENT); }
<LINE, ADJACENT_TYAPP> "(*"             { initBlockComment(); }
...
<LINE, ADJACENT_TYAPP, INIT_ADJACENT_TYAPP> ^{PP_DIRECTIVE}         { yypushback(yylength()); yybegin(PPDIRECTIVE); }
...
<SMASH_ADJACENT_GREATER_BAR_RBRACK, SMASH_ADJACENT_GREATER_BAR_RBRACK_FIN> {BAR_RBRACK} { exitSmash(SMASH_ADJACENT_GREATER_BAR_RBRACK_FIN); return makeToken(RBRACK); }
