...
object FSharpFileType : RiderLanguageFileTypeBase(FSharpLanguage) {
  ...
  override fun getDescription() = FSharpBundle.message("FSharpFileType.label.fsharp.file")
...
object FSharpScriptFileType : RiderLanguageFileTypeBase(FSharpLanguage) {
  ...
  override fun getDescription() = FSharpBundle.message("FSharpScriptFileType.label.fsharp.file")
