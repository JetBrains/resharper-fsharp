...
val pluginFiles = listOf(
        Pair("FSharp.ProjectModelBase", "JetBrains.ReSharper.Plugins.FSharp.ProjectModelBase"),
        Pair("FSharp.Common", "JetBrains.ReSharper.Plugins.FSharp.Common"),
        Pair("FSharp.Psi", "JetBrains.ReSharper.Plugins.FSharp.Psi"),
        Pair("FSharp.Psi.Features", "JetBrains.ReSharper.Plugins.FSharp.Psi.Features"),
        Pair("Daemon.FSharp", "JetBrains.ReSharper.Plugins.FSharp.Daemon.Cs"),
        Pair("Services.FSharp", "JetBrains.ReSharper.Plugins.FSharp.Services.Cs"),
        Pair("Expecto.Runner", "JetBrains.ReSharper.Plugins.FSharp.Expecto.Runner"),
        Pair("Expecto.Tasks", "JetBrains.ReSharper.Plugins.FSharp.Expecto.Tasks"))
