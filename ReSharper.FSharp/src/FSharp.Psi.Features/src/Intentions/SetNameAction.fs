...
open JetBrains.ReSharper.Plugins.FSharp.Psi.Features.Util.NamingUtils.FSharpNamingService
...
type SetNameAction(dataProvider: FSharpContextActionDataProvider) =
    ...
    override x.ExecutePsiTransaction(_, _) =
        ...
        let elementType =
            ...
            | :? ITopBinding as topBinding when
                    not (topBinding.HeadPattern :? IParametersOwnerPat) ->
                ElementType.TOP_REFERENCE_PAT
