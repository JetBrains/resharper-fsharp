...
type ImplementInterfaceMemberRule() =
    ...
    override this.IsAvailable(context) =
        context
        |> isOverrideRuleAvailable isWhitespace (fun owner -> (owner :? IInterfaceImplementation))
    ...
    override this.AddLookupItems(context, collector) =
        addInterfaceImplMemberItems
            ...
            [| (fun memberDecl ->
                   ...
                   let text =
                       "member " + originalText.RemoveStart($"{memberDecl.MemberKeyword.GetText()} ")
               ...
               (fun memberDecl ->
                   ...
                   let text =
                       "override " + originalText.RemoveStart($"{memberDecl.MemberKeyword.GetText()} ")
...
type QualifiedImplementInterfaceMemberRule() =
    ...
    override this.IsAvailable(context) =
        context
        |> isOverrideRuleAvailable isDot (fun owner -> (owner :? IInterfaceImplementation))
