...
type internal FSharpSigTreeBuilder(sourceFile, lexer, sigs, warnDirectives, lifetime, path) =
    inherit FSharpTreeBuilderBase(sourceFile, lexer, warnDirectives, lifetime, path)
