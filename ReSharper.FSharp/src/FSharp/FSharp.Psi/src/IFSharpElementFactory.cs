...
namespace JetBrains.ReSharper.Plugins.FSharp.Psi
{
  ...
  public interface IFSharpElementFactory
  {
    ...
    FSharpList<IParametersPatternDeclaration> CreateMemberParamDeclarations(FSharpList<FSharpList<Tuple<string, FSharpType>>> curriedParameterNames, bool isSpaceAfterComma);
    IMemberDeclaration CreateMemberDecl(bool isStatic, string bindingName, FSharpList<string> typeParameters, FSharpList<IParametersPatternDeclaration> args);
    IMemberDeclaration CreatePropertyWithAccessor(bool isStatic, string propertyName, string accessorName, FSharpList<IParametersPatternDeclaration> args);
