...
{
  public static class FSharpModifiersUtil
  {
      ...
      TreeNodeCollection<IAttribute> attributes)
    {
      ...
      return Normalize(decoration, false);
    }
    ...
    public static MemberDecoration GetModifiers(this TypePart typePart)
    {
      ...
      if (sigPart != null)
        return Normalize(sigPart.Modifiers, true);
      ...
      if (typePart.GetRoot() is FSharpProjectFilePart { HasPairSignaturePairFile: true })
      ...
      return Normalize(decoration, true);
    }

    private static MemberDecoration Normalize(MemberDecoration decoration, bool isCompiled)
    {
      ...
      var accessRights = decoration.AccessRights;
      if (accessRights == AccessRights.NONE)
        decoration.AccessRights = AccessRights.PUBLIC;

      if (isCompiled && accessRights != AccessRights.NONE && accessRights != AccessRights.PUBLIC)
        decoration.AccessRights = AccessRights.INTERNAL;
