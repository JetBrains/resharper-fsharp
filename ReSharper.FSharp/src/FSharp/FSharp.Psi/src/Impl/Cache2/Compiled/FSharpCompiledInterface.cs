...
{
  public class FSharpCompiledInterface : Interface, IFSharpCompiledTypeElement
  {
    ...
    public FSharpCompiledInterface(FSharpMetadataEntity entity, [NotNull] ICompiledEntity parent,
