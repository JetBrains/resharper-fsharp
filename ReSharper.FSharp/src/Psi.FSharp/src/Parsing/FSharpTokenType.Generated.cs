...
namespace JetBrains.ReSharper.Psi.FSharp.Parsing
{
  public partial class FSharpTokenType
  {
    ...
    public static readonly TokenNodeType PUBLIC = new FSharpTokenNodeType("PUBLIC", PUBLIC_NODE_TYPE_INDEX);
    public const int PRIVATE_NODE_TYPE_INDEX = 1001;
    public static readonly TokenNodeType PRIVATE = new FSharpTokenNodeType("PRIVATE", PRIVATE_NODE_TYPE_INDEX);
    public const int INTERNAL_NODE_TYPE_INDEX = 1002;
    public static readonly TokenNodeType INTERNAL = new FSharpTokenNodeType("INTERNAL", INTERNAL_NODE_TYPE_INDEX);
    public const int NAMESPACE_NODE_TYPE_INDEX = 1003;
    public static readonly TokenNodeType NAMESPACE = new FSharpTokenNodeType("NAMESPACE", NAMESPACE_NODE_TYPE_INDEX);
    public const int MODULE_NODE_TYPE_INDEX = 1004;
    public static readonly TokenNodeType MODULE = new FSharpTokenNodeType("MODULE", MODULE_NODE_TYPE_INDEX);
