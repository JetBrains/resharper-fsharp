...
namespace JetBrains.ReSharper.Plugins.FSharp.TypeProviders.Protocol.Models
{
  ...
  public class ProxyProvidedConstructorInfoWithContext : ProvidedConstructorInfo
  {
    private readonly ProvidedConstructorInfo myConstructorInfo;

    internal ProxyProvidedConstructorInfoWithContext(ProvidedConstructorInfo methodInfo, ProvidedTypeContext context) :
      base(null, context)
    {
