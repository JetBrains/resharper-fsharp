...
namespace JetBrains.ReSharper.Plugins.FSharp.TypeProvidersLoader.Protocol.Hosts
{
  public class ProvidedExprHostFactory : IOutOfProcessHostFactory<RdProvidedExprProcessModel>
  {
    ...
    public ProvidedExprHostFactory(UnitOfWork unitOfWork)
    {
    ...
    {
      var (providedExpr, typeProviderId) = myUnitOfWork.ProvidedExprsCache.Get(entityId);
      ...
      {
        var providedTypeId = myUnitOfWork.ProvidedTypeRdModelsCreator
          .CreateRdModel(providedNewArrayExprType.Item1, typeProviderId)
          .EntityId;
        var providedExprs = providedNewArrayExprType.Item2
          .Select(t => myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(t, typeProviderId))
          .ToArray();
      ...
      else if (exprTypeValue is ProvidedExprType.ProvidedNewObjectExpr providedNewObjectExprType)
      {
        var providedConstructorInfo =
          myUnitOfWork.ProvidedConstructorInfoRdModelsCreator.CreateRdModel(providedNewObjectExprType.Item1,
            typeProviderId);
      ...
      {
        var providedExpr1 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedWhileLoopExprType.Item1, typeProviderId);
        var providedExpr2 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedWhileLoopExprType.Item2, typeProviderId);
      ...
      else if (exprTypeValue is ProvidedExprType.ProvidedNewDelegateExpr providedNewDelegateExprType)
      {
        ...
        var providedVars = providedNewDelegateExprType.Item2
          .Select(t => myUnitOfWork.ProvidedVarRdModelsCreator.CreateRdModel(t, typeProviderId))
          .ToArray();
        var providedExprModel =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedNewDelegateExprType.Item3, typeProviderId);
      ...
      {
        var providedVar =
          myUnitOfWork.ProvidedVarRdModelsCreator.CreateRdModel(providedForIntegerRangeLoopExprType.Item1,
            typeProviderId);
        var providedExpr1 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedForIntegerRangeLoopExprType.Item2,
            typeProviderId);
        var providedExpr2 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedForIntegerRangeLoopExprType.Item3,
            typeProviderId);
        var providedExpr3 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedForIntegerRangeLoopExprType.Item4,
            typeProviderId);
      ...
      {
        var providedExpr1 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedSequentialExprType.Item1, typeProviderId);
        var providedExpr2 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedSequentialExprType.Item2, typeProviderId);
      ...
      {
        var providedExpr1 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedTryWithExprType.Item1, typeProviderId);
        var providedVar1 =
          myUnitOfWork.ProvidedVarRdModelsCreator.CreateRdModel(providedTryWithExprType.Item2, typeProviderId);
        var providedExpr2 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedTryWithExprType.Item3, typeProviderId);
        var providedVar2 =
          myUnitOfWork.ProvidedVarRdModelsCreator.CreateRdModel(providedTryWithExprType.Item4, typeProviderId);
        var providedExpr3 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedTryWithExprType.Item5, typeProviderId);
        providedTryWithExpr =
      ...
      {
        var providedExpr1 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedTryFinallyExprType.Item1, typeProviderId);
        var providedExpr2 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedTryFinallyExprType.Item2, typeProviderId);
      ...
      {
        var providedVar =
          myUnitOfWork.ProvidedVarRdModelsCreator.CreateRdModel(providedLambdaExprType.Item1, typeProviderId);
        var providedExprModel =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedLambdaExprType.Item2, typeProviderId);
      ...
      else if (exprTypeValue is ProvidedExprType.ProvidedCallExpr providedCallExprType)
      {
        var providedExprModel = FSharpOption<ProvidedExpr>.get_IsSome(providedCallExprType.Item1)
          ? myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedCallExprType.Item1.Value, typeProviderId)
          : null;
        var providedMethod =
          myUnitOfWork.ProvidedMethodInfoRdModelsCreator.CreateRdModel(providedCallExprType.Item2, typeProviderId);
      ...
      else if (exprTypeValue is ProvidedExprType.ProvidedConstantExpr providedConstantExprType)
      {
        ...
        var providedTypeId = myUnitOfWork.ProvidedTypeRdModelsCreator
          .CreateRdModel(providedConstantExprType.Item2, typeProviderId)
          .EntityId;
      ...
      {
        var providedTypeId = myUnitOfWork.ProvidedTypeRdModelsCreator
          .CreateRdModel(providedDefaultExprType.Item, typeProviderId)
          .EntityId;
      ...
      {
        var providedExprModel =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedTupleGetExprType.Item1, typeProviderId);
      ...
      {
        var providedExprModel =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedTypeAsExprType.Item1, typeProviderId);
        var providedTypeId = myUnitOfWork.ProvidedTypeRdModelsCreator
          .CreateRdModel(providedTypeAsExprType.Item2, typeProviderId)
          .EntityId;
      ...
      {
        var providedExprModel =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedTypeTestExprType.Item1, typeProviderId);
        var providedTypeId = myUnitOfWork.ProvidedTypeRdModelsCreator
          .CreateRdModel(providedTypeTestExprType.Item2, typeProviderId)
          .EntityId;
      ...
      {
        var providedVar =
          myUnitOfWork.ProvidedVarRdModelsCreator.CreateRdModel(providedLetExprType.Item1, typeProviderId);
        var providedExpr1 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedLetExprType.Item2, typeProviderId);
        var providedExpr2 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedLetExprType.Item3, typeProviderId);
      ...
      {
        var providedVar =
          myUnitOfWork.ProvidedVarRdModelsCreator.CreateRdModel(providedVarSetExprType.Item1, typeProviderId);
        var providedExprModel =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedVarSetExprType.Item2, typeProviderId);
      ...
      {
        var providedExpr1 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedIfThenElseExprType.Item1, typeProviderId);
        var providedExpr2 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedIfThenElseExprType.Item2, typeProviderId);
        var providedExpr3 =
          myUnitOfWork.ProvidedExprRdModelsCreator.CreateRdModel(providedIfThenElseExprType.Item3, typeProviderId);
      ...
      {
        var providedVar =
          myUnitOfWork.ProvidedVarRdModelsCreator.CreateRdModel(providedVarExprType.Item, typeProviderId);
