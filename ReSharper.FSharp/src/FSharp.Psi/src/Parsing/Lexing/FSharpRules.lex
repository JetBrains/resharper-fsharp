...
REGULAR_INTERPOLATED_STRING_LITERAL_CHARACTER=({SINGLE_REGULAR_INTERPOLATED_STRING_LITERAL_CHARACTER}|{SIMPLE_ESCAPE_SEQUENCE}|{UNICODEGRAPH_SHORT}|{UNICODEGRAPH_LONG}|{BRACE_ESCAPE_SEQUENCE})
