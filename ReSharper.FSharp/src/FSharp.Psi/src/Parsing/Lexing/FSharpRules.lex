...
<LINE, TYPE_APP> {RESERVED_SYMBOLIC_SEQUENCE} { UnfinishedIdent(); return MakeToken(RESERVED_SYMBOLIC_SEQUENCE); }
...
<INIT_TYPE_APP> {RESERVED_SYMBOLIC_SEQUENCE} { yybegin(LINE); UnfinishedIdent(); return MakeToken(RESERVED_SYMBOLIC_SEQUENCE); }
