...
using CommentType = JetBrains.ReSharper.Plugins.FSharp.Psi.Impl.Tree.CommentType;

namespace JetBrains.ReSharper.Plugins.FSharp.Psi.Impl.DocComments
{
  internal class FSharpDocCommentXmlPsi : ClrDocCommentXmlPsi<FSharpDocCommentBlock>
  {
    private FSharpDocCommentXmlPsi(
      [NotNull] InjectedPsiHolderNode docCommentsHolder,
      [NotNull] FSharpDocCommentBlock fSharpDocCommentBlock,
    ...
    [NotNull]
    public static FSharpDocCommentXmlPsi BuildPsi([NotNull] FSharpDocCommentBlock block)
    {
      BuildXmlPsi(
