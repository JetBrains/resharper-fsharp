...
type RedundantParenTypeUsageTest() =
    ...
    [<Test>] member x.``Nullable - Case field 01``() = x.DoNamedTest()
    [<Test>] member x.``Nullable - Function 01``() = x.DoNamedTest()
    [<Test>] member x.``Nullable - Function 02``() = x.DoNamedTest()
    [<Test>] member x.``Nullable - Function 03``() = x.DoNamedTest()
    [<Test>] member x.``Nullable - Function 04``() = x.DoNamedTest()
    [<Test>] member x.``Nullable - Tuple 01``() = x.DoNamedTest()
    [<Test>] member x.``Nullable - Tuple 02``() = x.DoNamedTest()
    [<Test>] member x.``Nullable - Tuple 03``() = x.DoNamedTest()
    [<Test>] member x.``Nullable - Array 01``() = x.DoNamedTest()
    [<Test>] member x.``Nullable - Postfix 01``() = x.DoNamedTest()
    [<Test>] member x.``Nullable - Prefix 01``() = x.DoNamedTest()
    [<Test>] member x.``Nullable - Nested 01``() = x.DoNamedTest()
    [<Test>] member x.``Nullable - Is pattern 01``() = x.DoNamedTest()
