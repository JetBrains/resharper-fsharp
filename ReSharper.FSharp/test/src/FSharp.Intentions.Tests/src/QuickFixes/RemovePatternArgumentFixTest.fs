...
type RemovePatternArgumentFixTest() =
    ...
    [<Test>] member x.``Literal pattern qualified single parameter`` () = x.DoNamedTest()
    [<Test>] member x.``Local literal constant pattern qualified parameter`` () = x.DoNamedTest()
    [<Test>] member x.``Local literal constant pattern qualified parens parameter`` () = x.DoNamedTest()
    [<Test>] member x.``Local literal pattern qualified match parens parameter`` () = x.DoNamedTest()
    [<Test>] member x.``Local literal pattern qualified single parameter`` () = x.DoNamedTest()
