...
type FSharpParameterInfoTest() =
    ...
    [<Test>] member x.``Pattern - Active pattern - Partial 01``() = x.DoNamedTest()
    [<Test>] member x.``Pattern - Active pattern - Partial 02``() = x.DoNamedTest()
    [<Test>] member x.``Pattern - Active pattern - Partial 03``() = x.DoNamedTest()
    [<Test>] member x.``Pattern - Active pattern - Partial 04``() = x.DoNamedTest()
    [<Test>] member x.``Pattern - Active pattern - Partial 05``() = x.DoNamedTest()
    [<Test>] member x.``Pattern - Active pattern - Partial 06``() = x.DoNamedTest()
    [<Test>] member x.``Pattern - Active pattern - Partial 07``() = x.DoNamedTest()
    [<Test; Explicit "Needs new FSharp.Core">] member x.``Pattern - Active pattern - Partial 08``() = x.DoNamedTest()

    [<Test>] member x.``Pattern - Active pattern - Total 01``() = x.DoNamedTest()
    [<Test>] member x.``Pattern - Active pattern - Total 02``() = x.DoNamedTest()
    [<Test>] member x.``Pattern - Active pattern - Total 03``() = x.DoNamedTest()
    [<Test>] member x.``Pattern - Active pattern - Total 04``() = x.DoNamedTest()
    [<Test>] member x.``Pattern - Active pattern - Total 05``() = x.DoNamedTest()
    [<Test>] member x.``Pattern - Active pattern - Total 06``() = x.DoNamedTest()
    [<Test>] member x.``Pattern - Active pattern - Total 07``() = x.DoNamedTest()
    [<Test>] member x.``Pattern - Active pattern - Total 08``() = x.DoNamedTest()
    [<Test>] member x.``Pattern - Active pattern - Total 09``() = x.DoNamedTest()
