...
type FSharpGoToInheritorsTest() =
    ...
    [<Test>] member x.``Object expr - Generic - External type params 01``() = x.DoNamedTest()
    [<Test>] member x.``Object expr - Generic - External type params 02``() = x.DoNamedTest()
    [<Test>] member x.``Object expr - Generic - External type params 03``() = x.DoNamedTest()
    [<Test>] member x.``Object expr - Generic - External type params 04``() = x.DoNamedTest()
    [<Test>] member x.``Object expr - Generic - Secondary interface 01``() = x.DoNamedTest()
    [<Test>] member x.``Object expr - Generic 01``() = x.DoNamedTest()
    [<Test>] member x.``Object expr - Generic 02``() = x.DoNamedTest()
    [<Test>] member x.``Object expr - Generic 03``() = x.DoNamedTest()
    [<Test>] member x.``Object expr - Generic 04``() = x.DoNamedTest()
    [<Test>] member x.``Object expr - Generic 05``() = x.DoNamedTest()
    [<Test>] member x.``Object expr - Generic 06``() = x.DoNamedTest()
