...
type FSharpExtendSelectionTest() =
    ...
    [<Test>] member x.``Strings - Interpolated - Verbatim 02 - After end brace``() = x.DoNamedTest()
    [<Test>] member x.``Strings - Interpolated - Verbatim 03 - After start brace``() = x.DoNamedTest()
    [<Test>] member x.``Strings - Interpolated - Verbatim 04 - Before end brace``() = x.DoNamedTest()
    [<Test>] member x.``Strings - Interpolated - Verbatim 05 - Before word``() = x.DoNamedTest()
    [<Test>] member x.``Strings - Interpolated - Verbatim 06 - Before last word``() = x.DoNamedTest()
    [<Test>] member x.``Strings - Interpolated - Verbatim 07 - After last word``() = x.DoNamedTest()
    [<Test>] member x.``Strings - Interpolated - Verbatim 08 - Without insertions``() = x.DoNamedTest()

    [<Test>] member x.``Strings - Interpolated - Triple quoted 01 - Before start brace``() = x.DoNamedTest()
    [<Test>] member x.``Strings - Interpolated - Triple quoted 02 - After end brace``() = x.DoNamedTest()
    [<Test>] member x.``Strings - Interpolated - Triple quoted 03 - After start brace``() = x.DoNamedTest()
    [<Test>] member x.``Strings - Interpolated - Triple quoted 04 - Before end brace``() = x.DoNamedTest()
    [<Test>] member x.``Strings - Interpolated - Triple quoted 05 - Before word``() = x.DoNamedTest()
    [<Test>] member x.``Strings - Interpolated - Triple quoted 06 - Before last word``() = x.DoNamedTest()
    [<Test>] member x.``Strings - Interpolated - Triple quoted 07 - After last word``() = x.DoNamedTest()
    [<Test>] member x.``Strings - Interpolated - Triple quoted 08 - Without insertions``() = x.DoNamedTest()
    [<Test>] member x.``Strings - Interpolated - Triple quoted 09 - Multiline``() = x.DoNamedTest()
    [<Test>] member x.``Strings - Interpolated - Triple quoted 10 - Complex insertion``() = x.DoNamedTest()
