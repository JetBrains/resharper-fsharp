...
type FSharpCompletionTest() =
    ...
    [<Test>] member x.``Override member - ObjExpr - Interface 02`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr - Interface 03`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr - Interface 04`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr - Interface 05`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr - Interface 06`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr - Interface 07`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr - Interface 08`` () = x.DoNamedTest()
    ...
    [<Test>] member x.``Override member - ObjExpr 05`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr 06`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr 07`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr 08`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr 09`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr 10`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr 11`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr 12`` () = x.DoNamedTest()
    [<Test; Explicit>] member x.``Override member - ObjExpr - Duplicates 01`` () = x.DoNamedTest()
    [<Test; Explicit>] member x.``Override member - ObjExpr - Duplicates 02`` () = x.DoNamedTest()
    [<Test; Explicit>] member x.``Override member - ObjExpr - Duplicates 03`` () = x.DoNamedTest()
    [<Test; Explicit>] member x.``Override member - ObjExpr - Duplicates 04`` () = x.DoNamedTest()
    [<Test; Explicit>] member x.``Override member - ObjExpr - Duplicates 05`` () = x.DoNamedTest()
    ...
    [<Test>] member x.``Override member 10`` () = x.DoNamedTest()
    ...
    [<Test>] member x.``Override member 14`` () = x.DoNamedTest()
    ...
    [<Test>] member x.``Override member - Duplicates 02`` () = x.DoNamedTest()
    ...
    [<Test>] member x.``Override member - WildSelfId 01`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr - WildSelfId 01`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - Property - WildSelfId 01`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - Interface 01`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - Interface 02`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - Interface - SelfId - Backticks 01`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - Interface then Override Base 01`` () = x.DoNamedTest()
...
type FSharpPostfixCompletionTest() =
    ...
    override this.SetupSettingsBeforeTest(textControl, settingsStore) =
