...
type FSharpCompletionTest() =
    ...
    [<Test>] member x.``Override member - ObjExpr - Duplicates 01`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr - Duplicates 02`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr - Duplicates 03`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr - Duplicates 04`` () = x.DoNamedTest()
    [<Test>] member x.``Override member - ObjExpr - Duplicates 05`` () = x.DoNamedTest()
