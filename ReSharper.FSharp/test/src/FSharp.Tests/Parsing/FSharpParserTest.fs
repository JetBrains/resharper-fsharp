...
type FSharpParserTest() =
    ...
    [<Test>] member x.``Directive - Nowarn 04 - Eof``() = x.DoNamedTest()
    ...
    [<Test>] member x.``Expr - Dynamic 01``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Dynamic 02 - Set``() = x.DoNamedTest()

    [<Test>] member x.``Expr - Paren 01``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Paren 02 - begin end``() = x.DoNamedTest()

    [<Test>] member x.``Expr - Typar 01``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Typar 02``() = x.DoNamedTest()
    ...
    [<Test>] member x.``Expr - Const - Measure - Divide 02``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Const - Measure - Named 01``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Const - Measure - One 01``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Const - Measure - One 02``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Const - Measure - One 03``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Const - Measure - One 04``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Const - Measure - One 05``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Const - Measure - Product 01``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Const - Measure - Power 01``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Const - Measure - Power 02``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Const - Measure - Power 03``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Const - Measure - Power 04``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Const - Measure - Power 05``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Const - Measure - Seq 01``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Const - Measure - Seq 02``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Const - Measure - Seq 03``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Const - Measure - Seq 04``() = x.DoNamedTest()
    ...
    [<Test>] member x.``Attribute 08 - Named arg``() = x.DoNamedTest()
    [<Test>] member x.``Attribute 09 - Named arg``() = x.DoNamedTest()
    ...
    [<Test>] member x.``Type member - Auto Property 06 - Access modifiers``() = x.DoNamedTest()
    [<Test>] member x.``Type member - Auto Property 07 - set, get``() = x.DoNamedTest()
    ...
    [<Test>] member x.``Type member - Member - Property - Accessors 07``() = x.DoNamedTest()
    [<Test>] member x.``Type member - Member - Property - Accessors 08 - Attributes``() = x.DoNamedTest()
    [<Test>] member x.``Type member - Member - Property - Accessors 10 - Return``() = x.DoNamedTest()
    [<Test>] member x.``Type member - Member - Property - Accessors 11 - Return``() = x.DoNamedTest()
    ...
    [<Test>] member x.``Module member - Open - Type - App 01``() = x.DoNamedTest()
...
type FSharpSignatureParserTest() =
    ...
    [<Test>] member x.``Type member - Constrained type usage``() = x.DoNamedTest()
...
type FSharpErrorsParserTest() =
    ...
    [<Test>] member x.``Expr - Object expr - Interface 01``() = x.DoNamedTest()
    [<Test>] member x.``Expr - Object expr - Interface 02``() = x.DoNamedTest()
