...
type FSharpLexerTest() =
    ...
    [<Test>] member x.``Preprocessor 05 - Elif 1 - Branch taken``() = x.DoNamedTest()
    [<Test>] member x.``Preprocessor 05 - Elif 2 - Branch skipped``() = x.DoNamedTest()
    [<Test>] member x.``Preprocessor 05 - Elif 3 - After else``() = x.DoNamedTest()
    [<Test>] member x.``Preprocessor 05 - Elif 4 - Nesting in dead branch``() = x.DoNamedTest()
    [<Test>] member x.``Preprocessor 05 - Elif 5 - Nesting in live branch``() = x.DoNamedTest()
    [<Test>] member x.``Preprocessor 05 - Elif 6 - No if``() = x.DoNamedTest()
    [<Test>] member x.``Preprocessor 05 - Elif 7 - Else taken``() = x.DoNamedTest()
    [<Test>] member x.``Preprocessor 05 - Elif 8 - Second branch taken``() = x.DoNamedTest()
    [<Test>] member x.``Preprocessor 05 - Elif 9 - No branch taken``() = x.DoNamedTest()
    [<Test>] member x.``Preprocessor 05 - Elif 10 - Nesting before taken branch``() = x.DoNamedTest()
    [<Test>] member x.``Preprocessor 05 - Elif 11 - Nesting before else``() = x.DoNamedTest()
    [<Test>] member x.``Preprocessor 05 - Elif 12 - After taken elif``() = x.DoNamedTest()
    [<Test>] member x.``Preprocessor 05 - Elif 13 - Indented``() = x.DoNamedTest()
    [<Test>] member x.``Preprocessor 06 - Else after else``() = x.DoNamedTest()
    ...
    [<Test>] member x.``Hash directives 05 - Elif``() = x.DoNamedTest()
