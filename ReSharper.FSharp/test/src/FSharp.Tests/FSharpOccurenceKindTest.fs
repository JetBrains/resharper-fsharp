...
type FSharpOccurenceKindTest() =
    ...
    [<Test>] member x.``Exception - Singleton 02 - Members``() = x.DoNamedTest()
    ...
    member x.``Write - Extension - Compiled 01``() = x.DoNamedTest()
    ...
    [<Test>] member x.``Write - Return 01``() = x.DoNamedTest()
